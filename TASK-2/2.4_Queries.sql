...
--7)
INSERT INTO student_hobby (id, student_id, hobby_id, date_start, date_finish)
VALUES (nextval('student_hobby_id_seq'), 4, 5, '2009-11-15', null);
...
VALUES (nextval('hobby_id_seq'), 'бальные танцы', 0.5);


INSERT INTO hobby (id, name, risk)
VALUES (nextval('hobby_id_seq'), 'вышивание крестиком', 0.3);
